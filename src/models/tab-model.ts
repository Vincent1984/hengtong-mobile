...
export class TabModel {
  ...
  public static buildSubTabs() {
    let tab_00 = new TabModel(ColumnWithMorePage, '1', '首页', 'tab01', ColumnInfoModel.buildSY());
    let tab_01 = new TabModel(ColumnWithMorePage, '1', '非遗', 'tab01', ColumnInfoModel.buildFY());
    let tab_02 = new TabModel(ColumnWithMorePage, '2', '讲堂', 'tab02', ColumnInfoModel.buildJT());
